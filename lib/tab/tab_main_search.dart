...
class SearchByConditionPage extends StatefulWidget {
  @override
  _SearchByConditionPageState createState() => _SearchByConditionPageState();
}

class _SearchByConditionPageState extends State<SearchByConditionPage> {
